            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">MyShop</h5>
                  </div>

                  <form class="row g-3 needs-validation" novalidate>

                    <div class="col-12">
                      <label for="yourUsername" class="form-label">관리자ID</label>
                      <div class="input-group has-validation">
                        <input type="text" name="manageId" class="form-control" id="manageId" required>
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="managePwd" class="form-control" id="managePwd" required>
...
function login(){
    ...
    if($('#rememberMe').is(':checked')) {
        $.cookie('manageId', $('#manageId').val(), { expires: 365, path: '/' });
    } else {
    	$.removeCookie('manageId', { path: '/' });
    }
}
